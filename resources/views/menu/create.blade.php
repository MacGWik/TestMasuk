                ...
                <div class="col-lg-12">
                    ...
                    <form role="form">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="text_menu" id="text_menu">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="link_menu" id="link_menu">
                            <p class="help-block">The link that will targeted by the menu (need to create the route and controller first) ex: "/group/create"</p>
                        </div>
                        <div class="form-group">
